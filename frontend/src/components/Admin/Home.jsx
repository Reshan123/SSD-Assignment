...
const Home = () => {
    ...
    const { inventoryitems, dispatch: inventoryDispatch } =
    ...
    const { requestForms, dispatch: requestDispatch } =
    ...
    useEffect(() => {
        const fetchAllData = async () => {
            try {
                ...
                //allDocData
                const allDocResponse = await fetch(
                    "http://localhost:4000/api/doctor/getAllDocs/"
                );
                ...
                //allPetOwnerData
                const allPetOwners = await fetch(
                ...
                const inventoryResponse = await fetch(
                    "http://localhost:4000/api/inventoryItems/"
                );
                ...
                const MedicalResponse = await fetch(
                    "http://localhost:4000/api/medicalRec/"
                );
                ...
                const adoptionResponse = await fetch(
                    "http://localhost:4000/api/adoption"
                );
                ...
                const requestResponse = await fetch(
                    "http://localhost:4000/api/adoptionRequest/getall"
                );
            ...
            <div className="adminPageMainContainer">
                    ...
                    <div className="pages">
                        <Routes>
                            ...
                            />
                            <Route
                                path="/InventoryItemForm"
                                element={<InventoryItemForm />}
                            />
                            <Route
                                path="/InventoryItemUpdate/:itemID"
                            ...
                            <Route
                                path="/adoption-forms/view-form/:id"
