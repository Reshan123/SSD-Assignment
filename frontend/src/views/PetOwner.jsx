  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/adopt/adoptionForm"
          element={<CreateAdoptionForm navBarProps={navBarProps} />}
        />
        <Route
          path="/profile/adoption-form-update/:id"
          element={<UpdateForm />}
        />
        <Route
          path="/adopt/form-details/:id"
          element={<ViewForm navBarProps={navBarProps} />}
        />
        <Route path="/signup" element={<SignUp navBarProps={navBarProps} />} />
        <Route
          path="/lostpetnotices"
          element={<LostPet navBarProps={navBarProps} />}
        />
        <Route
          path="/lostpetnotices/alldetails"
          element={<AllLostPetDetails navBarProps={navBarProps} />}
        />
        <Route
          path="/lostpetnotices/lostpetform"
          element={<LostNoticeForm navBarProps={navBarProps} />}
        />
        <Route
          path="/lostpetnotices/lostpetform/updatelostpet"
          element={<LostPetUpdateForm navBarProps={navBarProps} />}
        />
        <Route
          path="/lostpetnotices/messages"
          element={<MessageContainer navBarProps={navBarProps} />}
        />
        <Route
          path="/profile"
          element={<Profile navBarProps={navBarProps} />}
        />
        <Route
          path="/profile/update"
          element={<ProfileUpdate navBarProps={navBarProps} />}
        />
        <Route
          path="/profile/addpet"
          element={<AddPetForm navBarProps={navBarProps} />}
        />
        <Route
          path="/profile/booking-update/:id"
          element={<UpdateBooking navBarProps={navBarProps} />}
        />
        <Route
          path="/profile/petUpdate/:id"
          element={<PetUpdate navBarProps={navBarProps} />}
        />
        <Route
          path="/adopt/adoptionrequest/:id/:petName"
          element={<AdoptionRequestForm />}
        />
